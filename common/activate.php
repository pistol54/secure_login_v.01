<?php
session_start();
require_once ('../assets/include/activate.php');
?>
...
<meta charset="utf-8">
<script language="JavaScript" type="text/javascript" src="../assests/js/jquery-1.3.2.min.js"></script>
<script language="JavaScript" type="text/javascript" src="../assests/js/jquery.validate.js"></script>
  <script>
...
<h3 class="titlehdr">Account Activation</h3>
	...
	if(!empty($err))  {
      ...
      <p>Please enter your email and activation code sent to you to your email 
        ...
        <a href="../login/login.php">login here</a>.</p>
