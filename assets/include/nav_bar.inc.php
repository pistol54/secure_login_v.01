...
<?php
		...
		if ($results = Check_Permissions() && ($_SESSION['user_level'] == ADMIN_LEVEL)) {
			$search = true;
			echo'<script src="assets/js/ajax.js"></script>';
?>
...
-->
 <?php
        ...
        <li><a href="login/login.php">Login</a> </li>
        <li><a href="login/register.php">Register</a></li> 
        <li><a href="install/install.php">Install</a></li> 
        <li><a href="php_info.php">PHP Information </a></li> 
        <li><a href="example.php">COOKIE Crypto  </a></li> 
